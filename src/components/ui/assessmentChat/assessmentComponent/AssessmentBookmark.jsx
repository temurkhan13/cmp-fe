...
const AsessmentBookmark = ({ date, messages }) => {
  const [bookmarks, setBookmarks] = useState(messages.map(() => false));
...
export default AsessmentBookmark;
