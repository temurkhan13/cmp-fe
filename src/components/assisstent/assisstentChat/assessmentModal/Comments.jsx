...
import { addComment,
  ...
  addReply,
  updateReply,
  deleteReply, } from '../../../../redux/slices/chatSlice';
...
const Comments = ({ comments }) => {
  ...
  const handleDeleteComment = (commentId, isReply, parentCommentId) => {
    ...
    if (isReply) {
      ...
      parentComment.replies = parentComment.replies.filter(reply => reply.replyId !== commentId);
            ...
            <div className="comment">
              ...
              <div className="comment-content">
                <div className="comment-header">
                  ...
                  >
                    <Dropdown.Item onClick={() => handleEditComment(comment.commentId)}>
                      Edit Comment
                    </Dropdown.Item>
                    <Dropdown.Item
                      onClick={() => handleDeleteComment(comment.commentId, false)}
                    >
                      Delete Comment
                    </Dropdown.Item>
                  </Dropdown>
                ...
                <div className="comment-body">
                  {editingComment === comment.commentId ? (
                    <input
                      ...
                      onKeyPress={(e) => {
                        if (e.key === 'Enter') handleSaveEdit(comment.commentId);
                      }}
                    />
                  ) : (
                    <>
                ...
                <div className="replies-toggle" onClick={() => toggleReplies(comment.commentId)}>
                    ...
                    <div className="reply-content">
                      <div className="reply-header">
                        ...
                        <Dropdown
                          ...
                          buttonClassName="dropdown-button"
                        >
                          <Dropdown.Item onClick={() => handleEditReply(comment.commentId, reply.replyId)}>
                            Edit Reply
                          </Dropdown.Item>
                          <Dropdown.Item
                            onClick={() => handleDeleteComment(reply.replyId, true, comment.commentId)}
                          >
                            Delete Reply
                          </Dropdown.Item>
                        </Dropdown>
                      ...
                      <div className="reply-body">
                        {editingComment === reply.replyId ? (
                          <input
                            ...
                            value={editedText}
                            onChange={(e) => setEditedText(e.target.value)}
                            onBlur={() => handleSaveReply(comment.commentId,reply.replyId)}
                            onKeyPress={(e) => {
                              if (e.key === 'Enter') handleSaveReply(comment.commentId,reply.replyId);
                            }}
                          />
                        ) : (
