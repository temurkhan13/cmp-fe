  ...
  return (
    <>
      ...
      <style>{`
        ...
        .cm-search-icon { font-size: 1.6rem; color: #999; flex-shrink: 0; }
        .cm-search-input {
          flex: 1;
          border: none;
          outline: none;
        ...
        .cm-filter-icon { font-size: 1.5rem; cursor: pointer; color: #666; flex-shrink: 0; }
        .cm-filter-icon:hover { color: #333; }
        .cm-filter-dropdown {
          position: absolute;
          top: 100%;
          right: 0;
        ...
        .cm-filter-item:hover { background: #f5f5f5; }
        .cm-filter-item.active { color: #0B1444; font-weight: 600; }
        ...
        /* Comment Body */
        .cm-comment-body, .cm-reply-body { flex: 1; min-width: 0; }
        .cm-comment-header {
          display: flex;
          align-items: center;
          justify-content: space-between;
        ...
        .cm-author-row { display: flex; align-items: baseline; gap: 0.5rem; }
        .cm-author { font-size: 1.3rem; font-weight: 600; color: #1a1a1a; }
        .cm-time { font-size: 1.1rem; color: #999; }

        /* Menu */
        .cm-menu-icon { color: #bbb; cursor: pointer; }
        .cm-menu-icon:hover { color: #666; }
        .cm-menu-btn {
        ...
        .cm-edit-input:focus { border-color: #a8c416; }
        ...
        .cm-input-box:focus-within { border-color: #C3E11D; }
        .cm-input-box input {
          flex: 1;
          border: none;
          outline: none;
        ...
        .cm-send-btn:not(:disabled):hover { color: #0B1444; }
        .cm-send-btn:disabled { cursor: default; opacity: 0.4; }
      `}</style>
    </>
  );
};
