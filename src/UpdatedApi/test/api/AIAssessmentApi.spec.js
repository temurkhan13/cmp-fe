...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChangeManagementPlateform.AIAssessmentApi();
  });
  ...
  describe('AIAssessmentApi', function() {
    describe('apiAssessmentInspirePost', function() {
      it('should call apiAssessmentInspirePost successfully', function(done) {
        //uncomment below and update the code to test apiAssessmentInspirePost
        //instance.apiAssessmentInspirePost(function(error) {
    ...
    describe('apiAssessmentPost', function() {
      it('should call apiAssessmentPost successfully', function(done) {
        //uncomment below and update the code to test apiAssessmentPost
        //instance.apiAssessmentPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('assessmentPatch', function() {
      it('should call assessmentPatch successfully', function(done) {
        //uncomment below and update the code to test assessmentPatch
        //instance.assessmentPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('surveyPatch', function() {
      it('should call surveyPatch successfully', function(done) {
        //uncomment below and update the code to test surveyPatch
        //instance.surveyPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('surveyPost', function() {
      it('should call surveyPost successfully', function(done) {
        //uncomment below and update the code to test surveyPost
        //instance.surveyPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
